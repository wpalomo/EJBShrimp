 ...
 */
@Embeddable
public class InvVentasMotivoAnulacionPK implements Serializable {
    ...
    public InvVentasMotivoAnulacionPK() {
    }

    public InvVentasMotivoAnulacionPK(String anuEmpresa, String anuPeriodo, String anuMotivo, String anuNumero) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof InvVentasMotivoAnulacionPK)) {
            return false;
        }
        InvVentasMotivoAnulacionPK other = (InvVentasMotivoAnulacionPK) object;
    ...
    public String toString() {
        return "inventario.entity.InvVentasMotivoAnulacionPK[ anuEmpresa=" + anuEmpresa + ", anuPeriodo=" + anuPeriodo + ", anuMotivo=" + anuMotivo + ", anuNumero=" + anuNumero + " ]";
    }
