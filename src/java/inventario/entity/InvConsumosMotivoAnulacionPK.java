 ...
 */
@Embeddable
public class InvConsumosMotivoAnulacionPK implements Serializable {
    ...
    public InvConsumosMotivoAnulacionPK() {
    }

    public InvConsumosMotivoAnulacionPK(String anuEmpresa, String anuPeriodo, String anuMotivo, String anuNumero) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof InvConsumosMotivoAnulacionPK)) {
            return false;
        }
        InvConsumosMotivoAnulacionPK other = (InvConsumosMotivoAnulacionPK) object;
    ...
    public String toString() {
        return "inventario.entity.InvConsumosMotivoAnulacionPK[ anuEmpresa=" + anuEmpresa + ", anuPeriodo=" + anuPeriodo + ", anuMotivo=" + anuMotivo + ", anuNumero=" + anuNumero + " ]";
    }
