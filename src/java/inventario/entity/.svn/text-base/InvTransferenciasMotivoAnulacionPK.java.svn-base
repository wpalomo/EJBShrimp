 ...
 */
@Embeddable
public class InvTransferenciasMotivoAnulacionPK implements Serializable {
    ...
    public InvTransferenciasMotivoAnulacionPK() {
    }

    public InvTransferenciasMotivoAnulacionPK(String anuEmpresa, String anuPeriodo, String anuMotivo, String anuNumero) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof InvTransferenciasMotivoAnulacionPK)) {
            return false;
        }
        InvTransferenciasMotivoAnulacionPK other = (InvTransferenciasMotivoAnulacionPK) object;
    ...
    public String toString() {
        return "inventario.entity.InvTransferenciasMotivoAnulacionPK[ anuEmpresa=" + anuEmpresa + ", anuPeriodo=" + anuPeriodo + ", anuMotivo=" + anuMotivo + ", anuNumero=" + anuNumero + " ]";
    }
