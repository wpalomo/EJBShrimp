...
public class InvFunListaProductosImpresionPlacasTO implements java.io.Serializable{
    ...
    public InvFunListaProductosImpresionPlacasTO(String lpspCodigoPrincipal, String lpspCodigoBarra, String lpspNombre, String proEmpaque, BigDecimal lpspPrecio1, BigDecimal lpspPrecio2, BigDecimal lpspPrecio3) {
