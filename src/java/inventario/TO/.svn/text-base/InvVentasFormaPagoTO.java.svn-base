...
//    private String ctaEmpresa;
    ...
    public InvVentasFormaPagoTO(Integer fpSecuencial, String fpDetalle, Boolean fpInactivo, String secCodigo, String ctaCodigo, String usrEmpresa, String usrCodigo, String usrFechaInserta) {
