...
//    private String bodega;
    ...
    public SaldoBodegaComprobacionTOOLD(String sbcProductoNombre, 
            String sbcProductoCodigo, String sbcMedida, BigDecimal sbcInicial, 
            BigDecimal sbcCompra, BigDecimal sbcVenta, BigDecimal sbcConsumo, 
            BigDecimal sbcTransferenciaI, BigDecimal sbcTransferenciaE, 
