...
public class InvListaConsultaCompraTO implements java.io.Serializable {
    ...
    public InvListaConsultaCompraTO(String compStatus, String compDocumentoNumero, String compFecha, String provCodigo, String provNombre, BigDecimal compBase0, BigDecimal compBaseImponible, BigDecimal compMontoIva, BigDecimal compTotal, String compFormaPago, String compObservaciones, String compNumero, String conContable) {
