...
public class InvProformasDetalleTO implements java.io.Serializable{
    ...
    public String toString(){
        return this.detSecuencia + " "  + this.detOrden + " " +
                this.detCantidad + " " + this.detPrecio + " " + this.detPorcentajeDescuento + " " +
                this.proEmpresa + " " + this.proCodigoPrincipal + " " + this.proNombre + " " +
                this.profEmpresa + " " + this.profPeriodo + " " + this.profMotivo + " " + this.profNumero;
    }
}
