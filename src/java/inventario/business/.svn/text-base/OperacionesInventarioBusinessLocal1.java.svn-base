 ...
 */
@Local
public interface OperacionesInventarioBusinessLocal1 {
    ...
    java.lang.String accionInvProveedorCategoria(inventario.TO.InvProveedorCategoriaTO invProveedorCategoriaTO, char accion, sistema.TO.SisInfoTO sisInfoTO) throws java.lang.Exception;

    java.util.List<inventario.TO.InvClienteCategoriaTO> getInvClienteCategoriaTO(java.lang.String empresa) throws java.lang.Exception;

    java.lang.String accionInvClienteCategoria(inventario.TO.InvClienteCategoriaTO invClienteCategoriaTO, char accion, sistema.TO.SisInfoTO sisInfoTO) throws java.lang.Exception;

    java.util.List<inventario.TO.InvProductoCategoriaTO> getInvProductoCategoriaTO(String empresa) throws Exception;

    String accionInvProductoCategoria(inventario.TO.InvProductoCategoriaTO invProductoCategoriaTO, char accion, sistema.TO.SisInfoTO sisInfoTO) throws java.lang.Exception;

    java.util.List<inventario.TO.InvProductoMedidaTO> getInvProductoMedidaTO(String empresa) throws Exception;

    String accionInvProductoMedida(inventario.TO.InvProductoMedidaTO invProductoMedidaTO, char accion, sistema.TO.SisInfoTO sisInfoTO) throws java.lang.Exception;

    inventario.TO.InvProductoDAOTO buscarInvProductoDAOTO(java.lang.String empresa, java.lang.String codigoProducto) throws java.lang.Exception;

    String insertarInvProductoTO(inventario.TO.InvProductoTO invProductoTO, sistema.TO.SisInfoTO sisInfoTO) throws Exception;
    ...
    inventario.TO.InvCompraCabeceraTO getInvCompraCabeceraTO(String empresa, String codigoPeriodo, String motivo, String numeroCompra) throws Exception;

    inventario.TO.InvVentaCabeceraTO getInvVentaCabeceraTO(String empresa, String codigoPeriodo, String motivo, String numeroVenta) throws Exception;

    inventario.TO.InvProformaCabeceraTO getInvProformaCabeceraTO(String empresa, String codigoPeriodo, String motivo, String numeroProforma) throws Exception;
    ...
    java.lang.String accionInvProductoPresentacionUnidadesTO(inventario.TO.InvProductoPresentacionUnidadesTO invProductoPresentacionUnidadesTO, char accion, sistema.TO.SisInfoTO sisInfoTO) throws java.lang.Exception;

    java.util.List<inventario.TO.InvProductoMarcaComboListadoTO> getInvMarcaComboListadoTO(String empresa) throws Exception;

    java.lang.String accionInvProductoMarcaTO(inventario.TO.InvProductoMarcaTO invProductoMarcaTO, char accion, sistema.TO.SisInfoTO sisInfoTO) throws java.lang.Exception;
    ...
    java.lang.String accionInvProductoPresentacionCajasTO(inventario.TO.InvProductoPresentacionCajasTO invProductoPresentacionCajasTO, char accion, sistema.TO.SisInfoTO sisInfoTO) throws java.lang.Exception;
    ...
    java.util.List<inventario.TO.InvListaProveedoresTO> getListaProveedoresTO(String empresa, String busqueda, boolean activoProveedor) throws Exception;
    ...
    String modificarInvProductoTO(inventario.TO.InvProductoTO invProductoTO, String codigoCambiarLlave, sistema.TO.SisInfoTO sisInfoTO) throws Exception;

    String eliminarInvProductoTO(inventario.TO.InvProductoTO invProductoTO, sistema.TO.SisInfoTO sisInfoTO) throws Exception;

    String insertarInvClienteTO(
    ...
    String modificarInvClienteTO(inventario.TO.InvClienteTO invClienteTO, String codigoAnterior, sistema.TO.SisInfoTO sisInfoTO) throws Exception;

    String insertarInvProveedorTO(inventario.TO.InvProveedorTO invProveedorTO, sistema.TO.SisInfoTO sisInfoTO) throws Exception;

    String modificarInvProveedorTO(inventario.TO.InvProveedorTO invProveedorTO, String codigoAnterior, sistema.TO.SisInfoTO sisInfoTO) throws Exception;

    String insertarInvBodegaTO(inventario.TO.InvBodegaTO invBodegaTO, sistema.TO.SisInfoTO sisInfoTO) throws Exception;

    String modificarInvBodegaTO(inventario.TO.InvBodegaTO invBodegaTO, sistema.TO.SisInfoTO sisInfoTO) throws Exception;
    ...
    inventario.TO.MensajeTO insertarInvConsumosTO(inventario.TO.InvConsumosTO invConsumosTO, java.util.List<inventario.TO.InvConsumosDetalleTO> listaInvConsumosDetalleTO, sistema.TO.SisInfoTO sisInfoTO) throws Exception;
    ...
    String insertarInvComprasMotivoTO(inventario.TO.InvComprasMotivoTO invCompraMotivoTO, sistema.TO.SisInfoTO sisInfoTO) throws Exception;

    String modificarInvComprasMotivoTO(inventario.TO.InvComprasMotivoTO invComprasMotivoTO, sistema.TO.SisInfoTO sisInfoTO) throws Exception;
    ...
    String insertarInvVentasMotivoTO(inventario.TO.InvVentaMotivoTO invVentaMotivoTO, sistema.TO.SisInfoTO sisInfoTO) throws Exception;

    String modificarInvVentasMotivoTO(inventario.TO.InvVentaMotivoTO invVentaMotivoTO, sistema.TO.SisInfoTO sisInfoTO) throws Exception;
    ...
    String insertarInvProformaMotivoTO(inventario.TO.InvProformaMotivoTO invProformaMotivoTO, sistema.TO.SisInfoTO sisInfoTO) throws Exception;

    String modificarInvProformaMotivoTO(inventario.TO.InvProformaMotivoTO invProformaMotivoTO, sistema.TO.SisInfoTO sisInfoTO) throws Exception;

    java.util.List<inventario.TO.InvProformaMotivoTablaTO> getListaInvProformaMotivoTablaTO(String empresa) throws Exception;

    inventario.TO.InvProformaMotivoTO getInvProformasMotivoTO(String empresa, inventario.TO.InvProformaMotivoTablaTO invVentaMotivoTablaTO) throws Exception;
    ...
    java.lang.String accionInvConsumosMotivo(inventario.TO.InvConsumosMotivoTO invConsumosMotivoTO, char accion, sistema.TO.SisInfoTO sisInfoTO) throws java.lang.Exception;

    inventario.TO.InvConsumosMotivoTO getInvConsumoMotivoTO(String empresa, inventario.TO.InvListaConsumosMotivoTO invListaConsumosMotivoTO) throws java.lang.Exception;

    java.util.List<inventario.TO.InvNumeracionCompraTO> getListaInvNumeracionCompraTO(java.lang.String empresa, java.lang.String periodo, java.lang.String motivo) throws java.lang.Exception;

    java.util.List<inventario.TO.InvNumeracionVentaTO> getListaInvNumeracionVentaTO(java.lang.String empresa, java.lang.String periodo, java.lang.String motivo) throws java.lang.Exception;

    java.util.List<inventario.TO.InvNumeracionConsumoTO> getListaInvNumeracionConsumoTO(java.lang.String empresa, java.lang.String periodo, java.lang.String motivo) throws java.lang.Exception;
    ...
    java.lang.String accionInvComprasPagosForma(inventario.TO.InvComprasFormaPagoTO invComprasFormaPagoTO, char accion, sistema.TO.SisInfoTO sisInfoTO) throws java.lang.Exception;
    ...
    java.lang.String accionInvVentasPagosForma(inventario.TO.InvVentasFormaPagoTO invVentasFormaPagoTO, char accion, sistema.TO.SisInfoTO sisInfoTO) throws java.lang.Exception;
    ...
    String insertarModificarComprasRecepcionTO(inventario.TO.InvComprasRecepcionTO invComprasRecepcionTO, sistema.TO.SisInfoTO sisInfoTO) throws Exception;
    ...
    inventario.TO.MensajeTO insertarInvTransferenciaTO(inventario.TO.InvTransferenciasTO invTransferenciasTO, java.util.List<inventario.TO.InvTransferenciasDetalleTO> listaInvTransferenciasDetalleTO, sistema.TO.SisInfoTO sisInfoTO) throws java.lang.Exception;
    ...
    inventario.TO.InvTransferenciaMotivoTO getInvTransferenciaMotivoTO(String empresa, inventario.TO.InvListaTransferenciaMotivoTO invListaTransferenciaMotivoTO) throws java.lang.Exception;

    java.lang.String accionInvTransferenciaMotivo(inventario.TO.InvTransferenciaMotivoTO invTransferenciaMotivoTO, char accion, sistema.TO.SisInfoTO sisInfoTO) throws java.lang.Exception;
    ...
    java.util.List<inventario.TO.InvListaDetalleTransferenciaTO> getListaInvTransferenciasDetalleTO(String empresa, String periodo, String motivo, String numeroConsumos) throws Exception;

    inventario.TO.InvTransferenciasTO getInvTransferenciasCabeceraTO(String empresa, String codigoPeriodo, String motivo, String numeroTransferencia) throws Exception;
    ...
    java.util.List<inventario.TO.InvListaConsultaTransferenciaTO> getListaInvConsultaTransferencias(String empresa, String periodo, String motivo, String busqueda, String nRegistros) throws Exception;
    ...
    java.util.List<inventario.TO.InvSincronizarTO> invProductoSincronizar(java.lang.String empresaOrigen, java.lang.String empresaDestino, java.lang.String usuario, sistema.TO.SisInfoTO sisInfoTO) throws java.lang.Exception;
    ...
    java.util.List<inventario.TO.InvFunComprasConsolidandoProductosTO> getInvFunComprasConsolidandoProductosTO(java.lang.String empresa, java.lang.String desde, java.lang.String hasta, java.lang.String sector, java.lang.String motivo, java.lang.String proveedor) throws java.lang.Exception;

    java.util.List<inventario.TO.InvFunVentasConsolidandoProductosTO> getInvFunVentasConsolidandoProductosTO(java.lang.String empresa, java.lang.String desde, java.lang.String hasta, java.lang.String sector, java.lang.String motivo, java.lang.String cliente) throws java.lang.Exception;
    ...
    java.math.BigDecimal getPrecioProductoPorCantidad(java.lang.String empresa, java.lang.String codProducto, java.math.BigDecimal cantidad) throws java.lang.Exception;
    ...
    java.lang.String accionInvProductoTipo(inventario.TO.InvProductoTipoTO invProductoTipoTO, char accion, sistema.TO.SisInfoTO sisInfoTO) throws java.lang.Exception;
    ...
    java.util.List<inventario.TO.InvFunConsumosTO> getInvFunConsumosTO(java.lang.String empresa, java.lang.String desde, java.lang.String hasta, java.lang.String motivo) throws java.lang.Exception;

    java.util.List<inventario.TO.InvFunConsumosConsolidandoProductosTO> getInvFunConsumosConsolidandoProductosTO(java.lang.String empresa, java.lang.String desde, java.lang.String hasta, java.lang.String sector, java.lang.String bodega) throws java.lang.Exception;
    ...
    java.lang.String accionInvVendedorTO(inventario.TO.InvVendedorTO invVendedorTO, char accion, sistema.TO.SisInfoTO sisInfoTO) throws java.lang.Exception;
    ...
    //java.lang.String accionInvInventarioTO(inventario.TO.InvVendedorTO invVendedorTO, char accion) throws java.lang.Exception;

    helper.RetornoTO getInvFunListaProductosSaldosGeneralTO(String empresa, String producto, String fecha, boolean estado, String usuario, sistema.TO.SisInfoTO sisInfoTO) throws Exception;
    ...
    inventario.TO.InvVentaRetencionesTO getInvVentaRetencionesTO(String codigoEmpresa, String facturaNumero) throws Exception;
    ...
    JasperPrint generarReporteCompraDetalle(SisUsuarioEmpresaTO sisUsuarioEmpresaTO,
