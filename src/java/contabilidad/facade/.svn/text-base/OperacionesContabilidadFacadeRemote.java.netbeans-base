...
import contabilidad.reporte.ReporteContableDetalle;
 ...
 */
@Remote
public interface OperacionesContabilidadFacadeRemote {

    ///// OBTENER LISTAS DE TIPOS, CUENTAS
    ...
    JasperPrint generarReporteMayorGeneral(
            ...
            String fechaHasta, String cuentaContable,
            List<ConMayorGeneralTO> listConMayorGeneralTO) throws Exception;
