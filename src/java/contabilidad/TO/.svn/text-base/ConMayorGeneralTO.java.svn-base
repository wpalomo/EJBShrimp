...
public class ConMayorGeneralTO implements java.io.Serializable{
    ...
    public ConMayorGeneralTO(String bgCuenta, String bgDetalle, BigDecimal bgSaldo6, BigDecimal bgSaldo5, BigDecimal bgSaldo4, BigDecimal bgSaldo3, BigDecimal bgSaldo2, BigDecimal bgSaldo1) {
