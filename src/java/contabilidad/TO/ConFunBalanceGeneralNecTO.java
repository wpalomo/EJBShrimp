...
public class ConFunBalanceGeneralNecTO implements java.io.Serializable{
    ...
    public ConFunBalanceGeneralNecTO(String bgCuenta, String bgDetalle, BigDecimal bgSaldo1, BigDecimal bgSaldo2, BigDecimal bgSaldo3, BigDecimal bgSaldo4, BigDecimal bgSaldo5, BigDecimal bgSaldo6) {
