 ...
 * @author jack
 */
public class ReporteCuentasPorCobrarGeneral implements Serializable {
    ...
    public ReporteCuentasPorCobrarGeneral(String codigoCP, String fechaHasta, String cxpgCodigo, String cxpgNombre, BigDecimal cxpgSaldo) {
