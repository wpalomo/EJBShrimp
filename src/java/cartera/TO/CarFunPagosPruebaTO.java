...
public class CarFunPagosPruebaTO implements java.io.Serializable{
    ...
    public CarFunPagosPruebaTO(String pagNumeroSistema, String pagFecha, String pagProveedor, BigDecimal pagValor, String pagObservaciones, Boolean pagPendiente, Boolean pagAnulado) {
