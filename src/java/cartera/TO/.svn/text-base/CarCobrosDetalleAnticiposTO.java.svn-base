...
public class CarCobrosDetalleAnticiposTO implements Serializable{
    ...
    public CarCobrosDetalleAnticiposTO(BigDecimal detValor, String detObservaciones, String antEmpresa, String antPeriodo, String antTipo, String antNumero, String antSector) {
