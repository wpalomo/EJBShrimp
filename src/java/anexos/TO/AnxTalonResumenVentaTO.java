...
public class AnxTalonResumenVentaTO implements java.io.Serializable {
    ...
    public AnxTalonResumenVentaTO(String venComprobante, String venEstablecimiento, String venPuntoEmision, BigDecimal venBaseNoObjetoIva, BigDecimal venBase0, BigDecimal venBaseImponible, BigDecimal venMotoIva, BigDecimal venValorRetenidoIva, BigDecimal venValorRetenidoRenta) {
