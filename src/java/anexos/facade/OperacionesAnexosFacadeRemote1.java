 ...
 */
@Remote
public interface OperacionesAnexosFacadeRemote1 {
    ...
    java.util.List<anexos.TO.AnxNumeracionTablaTO> getListaAnexoNumeracionTO(
    ...
    java.lang.String accionAnxVentaElectronica(
            anexos.TO.AnxVentaElectronicaTO anxVentaElectronicaTO,
            char accion,
            sistema.TO.SisInfoTO sisInfoTO) throws java.lang.Exception;

    java.lang.String accionAnxCompraElectronica(
    ...
    byte[] getXmlComprobanteElectronico(
            String empresa,
            String ePeriodo,
            String eMotivo,
            String eNumero) throws Exception;
