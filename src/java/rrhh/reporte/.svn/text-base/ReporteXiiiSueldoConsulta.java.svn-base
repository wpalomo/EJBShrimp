...
public class ReporteXiiiSueldoConsulta {
    ...
    public ReporteXiiiSueldoConsulta(String sector, String periodo, String fechaDesde, String fechaHasta, String fechaMaxima, String xiiiCategoria, String xiiiSector, String xiiiId, String xiiiNombres, String xiiiApellidos, Character xiiiGenero, String xiiiFechaIngreso, String xiiiCargo, BigDecimal xiiiTotalIngresos, Short xiiiDiasLaborados, BigDecimal xiiiValorXiiiSueldo, Character xiiiCodigoMinisterial, String xiiiPeriodo, String xiiiTipo, String xiiiNumero) {
        this.sector = sector;
