...
public class ReporteConsolidadoRol {
    ...
    public ReporteConsolidadoRol(String desde, String hasta, String categoria, String empleado, String crpCategoria, String crpId, String crpNombres, BigDecimal crpDl, BigDecimal crpDf, BigDecimal crpDe, BigDecimal crpDd, BigDecimal crpDp, BigDecimal crpSueldo, BigDecimal crpBonos, BigDecimal crpBonosnd, BigDecimal crpBonoFijo, BigDecimal crpBonoFijoNd, BigDecimal crpOtrosIngresos, BigDecimal crpOtrosIngresosNd, BigDecimal crpSubtotalBonos, BigDecimal crpSubtotalIngresos, BigDecimal crpViaticos, BigDecimal crpFondoReserva, BigDecimal crpLiquidacion, BigDecimal crpIngresos, BigDecimal crpAnticipos, BigDecimal crpPrestamos, BigDecimal crpIess, BigDecimal crpRetencion, BigDecimal crpDescuentosFondoReserva, BigDecimal crpDescuentos, BigDecimal crpTotal) {
        this.desde = desde;
        this.hasta = hasta;
