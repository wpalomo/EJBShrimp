 ...
 */
@Remote
public interface OperacionesRRHHFacadeRemote {
    ...
    RhCategoriaTO getRhCategoriaTO(String empCodigo, String catNombre) throws Exception;
    ...
    List<RhListaFormaPagoTO> getListaRhFormaPagoTO(String empresa) throws Exception;

    List<RhComboFormaPagoTO> getComboRhFormaPagoTO(String empresa) throws Exception;
    ...
    List<RhListaFormaPagoBeneficioSocialTO> getListaRhFormaPagoBeneficioSocialTO(String empresa) throws Exception;

    List<RhComboFormaPagoBeneficioSocialTO> getComboRhFormaPagoBeneficioSocialTO(String empresa) throws Exception;
    ...
    List<RhListaBonoConceptoTO> getListaRhBonoConceptoTO(String empresa) throws Exception;

    List<RhComboBonoConceptoTO> getComboRhBonoConceptoTO(String empresa) throws Exception;
    ...
    java.util.List<rrhh.TO.RhUtilidadesPeriodoTO> getRhComboUtilidadesTO(java.lang.String empresa) throws java.lang.Exception;
    ...
    JasperPrint generarReporteDetalleAnticipos(
            ...
            List<RhListaDetalleAnticiposTO> listaDetalleAnticiposTO) throws java.lang.Exception;
    ...
    JasperPrint generarReporteDetalleAnticiposPrestamos(
            ...
            List<RhListaDetalleAnticiposPrestamosTO> listaDetalleAnticiposPrestamosTO) throws java.lang.Exception;

    JasperPrint generarReporteDetallePrestamos(
            SisUsuarioEmpresaTO sisUsuarioEmpresaTO, String empCodigo, String fechaDesde, String fechaHasta,
            String empCategoria, String empId,
            List<RhListaDetallePrestamosTO> listaDetallePrestamosTO) throws java.lang.Exception;

    JasperPrint generarReporteDetalleBonos(
            SisUsuarioEmpresaTO sisUsuarioEmpresaTO, String fechaDesde, String fechaHasta,
            String empCategoria, String nombreEmpleado,
            List<RhListaDetalleBonosTO> listaDetalleBonosTO) throws java.lang.Exception;

    JasperPrint generarReporteDetalleBonosLote(
            SisUsuarioEmpresaTO sisUsuarioEmpresaTO, String periodo, String tipo,
            String numero, List<RhListaDetalleBonosLoteTO> listaDetalleBonosLoteTO) throws java.lang.Exception;
    ...
    JasperPrint generarReporteDetalleViaticos(SisUsuarioEmpresaTO sisUsuarioEmpresaTO,
            ...
            List<RhListaDetalleViaticosTO> listaDetalleViaticosTO) throws java.lang.Exception;

    JasperPrint generarReporteConsolidadoBonosViatico(SisUsuarioEmpresaTO sisUsuarioEmpresaTO,
            String fechaDesde, String fechaHasta,
            List<RhListaConsolidadoBonosViaticosTO> listaConsolidadoBonosViaticosTO) throws java.lang.Exception;

    JasperPrint generarReporteListadoRolesPago(SisUsuarioEmpresaTO sisUsuarioEmpresaTO,
            String fechaDesde, String fechaHasta, String empCategoria, String nombreEmpleado,
            List<RhListaDetalleRolesTO> listaDetalleRolesTO) throws java.lang.Exception;

    JasperPrint generarReporteConsolidadoRoles(
            SisUsuarioEmpresaTO sisUsuarioEmpresaTO, String fechaDesde, String fechaHasta, String empCategoria,
            String nombreEmpleado, List<RhListaConsolidadoRolesTO> listaConsolidadoRolesTO) throws java.lang.Exception;
    ...
    JasperPrint generarReporteSaldoIndividualAnticiposPrestamos(
            ...
            List<RhListaSaldoIndividualAnticiposPrestamosTO> listaSaldoIndividualAnticiposPrestamosTO) throws java.lang.Exception;

    JasperPrint generarReporteSaldoConsolidadoAnticiposPrestamos(
            SisUsuarioEmpresaTO sisUsuarioEmpresaTO, String fechaHasta,
            List<RhListaSaldoConsolidadoAnticiposPrestamosTO> listaSaldoConsolidadoAnticiposPrestamosTO) throws java.lang.Exception;

    JasperPrint generarReporteSaldoConsolidadoBonosViaticos(
            SisUsuarioEmpresaTO sisUsuarioEmpresaTO, String fechaHasta,
            List<RhListaSaldoConsolidadoBonosViaticosTO> listaSaldoConsolidadoBonosViaticosTO) throws java.lang.Exception;

    JasperPrint generarReporteSaldoConsolidadoSueldosPorPagar(
            SisUsuarioEmpresaTO sisUsuarioEmpresaTO, String fechaHasta,
            List<RhListaSaldoConsolidadoSueldosPorPagarTO> listaSaldoConsolidadoSueldosPorPagarTO) throws java.lang.Exception;
    ...
    JasperPrint generarReporteXiiiSueldoConsulta(SisUsuarioEmpresaTO sisUsuarioEmpresaTO,
            ...
            String fechaMaxima, List<RhFunXiiiSueldoConsultarTO> rhFunXiiiSueldoConsultarTO) throws java.lang.Exception;

    JasperPrint generarReporteXivSueldoConsulta(SisUsuarioEmpresaTO sisUsuarioEmpresaTO,
            String sector, String periodo, String fechaDesde, String fechaHasta,
            String fechaMaxima,
            List<RhFunXivSueldoConsultarTO> rhFunXivSueldoConsultarTO) throws java.lang.Exception;

    JasperPrint generarReporteUtilidadesPreCalculo(SisUsuarioEmpresaTO sisUsuarioEmpresaTO,
            String sector, String periodo, String fechaDesde, String fechaHasta,
            String fechaMaxima,
            List<RhFunUtilidadesCalcularTO> rhFunUtilidadesCalcularTOs) throws java.lang.Exception;

    JasperPrint generarReporteProvisionesComprobanteContable(
            SisUsuarioEmpresaTO sisUsuarioEmpresaTO, String periodo, String tipo,
            String numero, List<RhListaProvisionesTO> listaProvisionesTO) throws java.lang.Exception;

    JasperPrint generarReporteFormulario107(
            SisUsuarioEmpresaTO sisUsuarioEmpresaTO, String fechaEntrega,
            String rucEmpleador, String razonSocial, String rucContador,
            RhFormulario107TO rhFormulario107TOGuardar) throws java.lang.Exception;

    JasperPrint generarReporteAnticipo(
            SisUsuarioEmpresaTO sisUsuarioEmpresaTO,
            List<ReporteAnticipoOprestamo> rhReporteAnticipoOprestamos) throws java.lang.Exception;

    JasperPrint generarReporteConsultaAnticiposLote(
            SisUsuarioEmpresaTO sisUsuarioEmpresaTO,
            List<ReporteConsultaAnticiposLote> lista) throws java.lang.Exception;

    JasperPrint generarReportePrestamoVista(SisUsuarioEmpresaTO sisUsuarioEmpresaTO,
            List<ReporteAnticipoOprestamo> lista) throws java.lang.Exception;

    JasperPrint generarReporteRol(SisUsuarioEmpresaTO sisUsuarioEmpresaTO,
            List<ReportesRol> lista) throws java.lang.Exception;

    JasperPrint generarReporteEmpleado(SisUsuarioEmpresaTO sisUsuarioEmpresaTO,
            List<ReporteEmpleado> listReporteEmpleado) throws java.lang.Exception;
