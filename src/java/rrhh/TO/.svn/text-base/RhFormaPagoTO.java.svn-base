...
//    private String ctaEmpresa;
    ...
    public RhFormaPagoTO(Integer fpSecuencial, String fpDetalle, Boolean fpInactivo, String secCodigo, String ctaCodigo, String usrEmpresa, String usrCodigo, String usrFechaInserta) {
    ...
    public String getInformacion(){
        return "Codigo Cuenta: "+ctaCodigo+
                "\nSecuencia: "+fpSecuencial+
                "\nDetalle: "+fpDetalle+
                "\nSector: "+secCodigo+
                "\nInactivo: "+fpInactivo+
                "\nInactivo: "+usrCodigo+
                "\nInactivo: "+usrFechaInserta;
    }
