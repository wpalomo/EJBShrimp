 ...
 * @author jack
 */
public class ResumenSiembraNombres {
    ...
    public ResumenSiembraNombres() {
    }

    public ResumenSiembraNombres(String rcSector, String rcPiscina, String rcCorrida, BigDecimal rcHectareaje, String rcFechaDesde, String rcFechaSiembra, String rcFechaPesca, String rcFechaHasta, BigDecimal rcEdad, BigDecimal rcDiasMuertos, Integer rcNumeroLarvas, Integer rcDensidad, String rcLaboratorio, String rcNauplio, BigDecimal rcBalanceado, BigDecimal rcBiomasa, BigDecimal rcBiomasaReal, BigDecimal rcConversion, BigDecimal rcTallaPromedio, BigDecimal rcPesoIdeal, String rcSobrevivencia) {
