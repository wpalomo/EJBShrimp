...
public class ReporteListadoFunAnalisisPeso {
    ...
    public ReporteListadoFunAnalisisPeso(String fecha, String apSector, String apPiscina, String apCorrida, BigDecimal apHectareas, String apFechaSiembra, String apFormaSiembra, BigDecimal apDensidadMetroCuadrado, BigDecimal apSobrevivenciaMetroCuadrado, BigDecimal apRaleo, BigDecimal apEdad, BigDecimal apPesoIdeal, BigDecimal apPesoSobreIdeal, BigDecimal apPesoPromedioActual, BigDecimal apPesoIncrementoSemana4, BigDecimal apPesoIncrementoSemana3, BigDecimal apPesoIncrementoSemana2, BigDecimal apPesoIncrementoSemana1, BigDecimal apPesoIncrementoPromedio, String apBalanceadoTipo, BigDecimal apBalanceadoSacos, BigDecimal apBalanceadoKilosHectarea, BigDecimal apBalanceadoAcumulado, BigDecimal apBiomasaProyectada, BigDecimal apConversionAlimenticia, String apLaboratorio, String apNauplio) {
        this.fecha = fecha;
