 ...
 */
@Local
public interface OperacionesProduccionBusinessLocal {
    ...
    boolean modificarPrdPiscina(
            PrdPiscinaTO prdPiscinaTO,
            sistema.TO.SisInfoTO sisInfoTO) throws Exception;
    boolean eliminarPrdPiscina(PrdPiscinaTO prdPiscinaTO,
            sistema.TO.SisInfoTO sisInfoTO) throws Exception;
    ...
    List<PrdComboPiscinaTO> getComboPiscinaTO(
            String empresa, 
            String sector) throws Exception;
    ...
    java.util.List<produccion.TO.PrdConsumosTO> getPrdConsumosPiscinaTO(
            java.lang.String empresa, 
            java.lang.String sector,
            java.lang.String piscina, java.lang.String fechaDesde, java.lang.String fechaHasta) throws java.lang.Exception;
    ...
    java.util.List<produccion.TO.PrdLiquidacionTallaTablaTO> getListaPrdLiquidacionTallaTablaTO(String empresa) throws Exception;
    java.util.List<produccion.TO.PrdLiquidacionTallaTablaTO> getListaPrdLiquidacionTallaTablaTO(String empresa,String codigo) throws Exception;
    ...
    java.util.List<produccion.TO.PrdLiquidacionProductoTablaTO> getListaPrdLiquidacionProductoTablaTO(String empresa) throws Exception;
    java.util.List<produccion.TO.PrdLiquidacionProductoTablaTO> getListaPrdLiquidacionProductoTablaTO(String empresa, String codigo) throws Exception;
    ...
    JasperPrint generarReporteListadoGramaje(SisUsuarioEmpresaTO 
            sisUsuarioEmpresaTO, String codigoSector, 
            String codigoPiscina, String codigoCorrida, 
