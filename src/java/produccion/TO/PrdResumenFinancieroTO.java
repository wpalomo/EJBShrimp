...
public class PrdResumenFinancieroTO implements java.io.Serializable{
    ...
    public PrdResumenFinancieroTO(String costoProducto, String costoCodigo, String costoMedida, BigDecimal costoCantidad, BigDecimal costoTotal, BigDecimal costoPorcentaje) {
