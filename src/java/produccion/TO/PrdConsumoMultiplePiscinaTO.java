 ...
 * @author jack
 */
public class PrdConsumoMultiplePiscinaTO implements java.io.Serializable {
    ...
    public PrdConsumoMultiplePiscinaTO() {
    }

    public PrdConsumoMultiplePiscinaTO(String consumoSector, String consumoProducto, String consumoCodigo, String consumoMedida, BigDecimal consumoCantidad) {
