 ...
 * @author jack
 */
public class PrdResumenSiembraTO {
    ...
    private java.math.BigDecimal rcEdad;
    private java.math.BigDecimal rcDiasMuertos;
    private Integer rcNumeroLarvas;
    private Integer rcDensidad;
    private String rcLaboratorio;
    private String rcNauplio;
    private java.math.BigDecimal rcBalanceado;
    private java.math.BigDecimal rcBiomasa;
    private java.math.BigDecimal rcBiomasaReal;
    private java.math.BigDecimal rcConversion;
    private java.math.BigDecimal rcTallaPromedio;
    private java.math.BigDecimal rcPesoIdeal;
    private String rcSobrevivencia;
    private String rcTipo;
    private java.math.BigDecimal rcTotal;

    public PrdResumenSiembraTO() {
    }

    public PrdResumenSiembraTO(String rcSector, String rcPiscina, String rcCorrida, BigDecimal rcHectareaje, String rcFechaDesde, String rcFechaSiembra, String rcFechaPesca, String rcFechaHasta, BigDecimal rcEdad, BigDecimal rcDiasMuertos, Integer rcNumeroLarvas, Integer rcDensidad, String rcLaboratorio, String rcNauplio, BigDecimal rcBalanceado, BigDecimal rcBiomasa, BigDecimal rcBiomasaReal, BigDecimal rcConversion, BigDecimal rcTallaPromedio, BigDecimal rcPesoIdeal, String rcSobrevivencia, String rcTipo, BigDecimal rcTotal) {
    ...
    public String getRcTipo() {
        return rcTipo;
    }

    public void setRcTipo(String rcTipo) {
        this.rcTipo = rcTipo;
    }
