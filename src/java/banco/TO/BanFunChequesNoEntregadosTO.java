...
public class BanFunChequesNoEntregadosTO implements java.io.Serializable {
    ...
    public BanFunChequesNoEntregadosTO(String chqCuentaCodigo, String chqCuentaDetalle, String chqBeneficiario, String chqNumero, BigDecimal chqValor, String chqFechaEmision, String chqFechaVencimiento, String chqObservacion, Boolean chqImpreso, Boolean chqRevisado, String chqContablePeriodo, String chqContableTipo, String chqContableNumero, BigInteger chqSecuencia, BigInteger chqOrden) {
    ...
    public BanFunChequesNoEntregadosTO(String chqCuentaCodigo, String chqCuentaDetalle, String chqBeneficiario, String chqNumero, BigDecimal chqValor, String chqFechaEmision, String chqFechaVencimiento, String chqObservacion, Boolean chqImpreso, Boolean chqRevisado, String chqContablePeriodo, String chqContableTipo, String chqContableNumero, BigInteger chqSecuencia, BigInteger chqOrden, boolean estado) {
        this.chqCuentaCodigo = chqCuentaCodigo;
        this.chqCuentaDetalle = chqCuentaDetalle;
        this.chqBeneficiario = chqBeneficiario;
        this.chqNumero = chqNumero;
